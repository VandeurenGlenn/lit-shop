...
cp('../../node_modules/@vandeurenglenn/custom-elements/exports/themes', 'www/themes', { recursive: true})
try { 
...
const dirs = (await readdir('./src/sections'))
  .map(dir => join('./src/sections', dir))
...
export default [{
  ...
  plugins: [
    ...
    typescript({ compilerOptions: { outDir: 'www', "experimentalDecorators": true }})
    // terser({ keep_classnames: true })
  ]
}];
