  ...
  #addImageTemplate() {
    return html`
                  ...
                  <flex-wrap-around>
                    ${map(
                      ...
                      (image: imgurBaseImage) => html`
                        <img
                          @click=${(event) =>
                            this.#onlibclick(event, image.firebaseKey)}
                          src=${`${
                            location.origin
                          }/api/image?image=${image.link.replace(
                            '.png',
                            'b.png'
                          )}`}
                        />
      ...
      <flex-row slot="actions">
        <md-text-button form="form-content" value="cancel"
          >cancel</md-text-button
        >
        <flex-one></flex-one>
        <md-text-button form="form-content" value="submit"
