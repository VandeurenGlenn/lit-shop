...
export default class ImgurBase extends Imgur {
    ...
    removeAlbum({ deletehash, firebaseKey }: imgurBaseAlbum): Promise<string>;
    getAlbum(firebaseKey: string): Promise<imgurBaseAlbum>;
    getAlbumImages(firebaseKey: string): Promise<imgurBaseImage[]>;
    addImage(image: imgurImageParams): Promise<imgurBaseImage>;
    getImage(firebaseKey: string): Promise<imgurBaseImage>;
    getImages(): Promise<imgurBaseImage[]>;
    removeImage({ deletehash, firebaseKey }: imgurBaseImage): Promise<string>;
    lookup(id: any): Promise<[string, unknown][]>;
}
